...
function displayClasses(filter = 'All') {
    ...
    const creditsRequired = filteredCourses.reduce((sum, course) => sum + course.credits, 0);
    document.getElementById("credits-required").textContent = `Credits Required: ${creditsRequired}`;
    ...
    filteredCourses.forEach(course => {
        ...
        if (course.completed) {
            courseDiv.style.border = "2px solid #A0B9C6";
